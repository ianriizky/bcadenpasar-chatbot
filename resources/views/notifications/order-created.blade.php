...
{{ __('admin-lang.customer') }}: <a href="{{ route('admin.customer.edit', $order->customer) }}">{{ $order->customer->fullname }}</a>
...
<strong>Selengkapnya bisa diakses di {{ route('admin.order.edit', $order) }}.</strong>
